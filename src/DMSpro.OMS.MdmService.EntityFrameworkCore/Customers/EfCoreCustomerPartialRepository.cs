...
{
    public partial class EfCoreCustomerRepository : EfCoreRepository<MdmServiceDbContext, Customer, Guid>, ICustomerRepository
    {
        ...
        public virtual async Task<List<Customer>> GetByIdAsync(List<Guid> ids)
        {
