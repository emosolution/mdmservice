...
public static class MdmServiceDbContextModelCreatingExtensions
{
        ...
        builder.Entity<SalesOrgEmpAssignment>(b =>
    {
        ...
        builder.Entity<Customer>(b =>
        {
            ...
            b.Property(x => x.FullAddress).HasColumnName(nameof(Customer.FullAddress)).HasMaxLength(CustomerConsts.FullAddressMaxLength);
            ...
            b.HasOne(x => x.GeoMaster0).WithMany().HasForeignKey(x => x.GeoMaster0Id).OnDelete(DeleteBehavior.NoAction);
