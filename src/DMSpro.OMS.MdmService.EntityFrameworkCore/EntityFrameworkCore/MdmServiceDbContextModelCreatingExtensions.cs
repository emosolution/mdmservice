...
public static class MdmServiceDbContextModelCreatingExtensions
{
        ...
        builder.Entity<Company>(b =>
    {
        ...
        b.HasOne<GeoMaster>(c => c.GeoLevel3).WithMany().HasForeignKey(x => x.GeoLevel3Id).OnDelete(DeleteBehavior.NoAction);
        b.HasOne<GeoMaster>(c => c.GeoLevel4).WithMany().HasForeignKey(x => x.GeoLevel4Id).OnDelete(DeleteBehavior.NoAction);
    });
