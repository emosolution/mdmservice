...
{
    public partial class Added_ItemAttributeValue : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemAttributeValues_ItemAttributes_ItemAttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemAttributeValues_ItemAttributeId",
