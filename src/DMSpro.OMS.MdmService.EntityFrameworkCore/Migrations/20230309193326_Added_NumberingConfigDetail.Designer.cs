...
namespace DMSpro.OMS.MdmService.Migrations
{
    ...
    [Migration("20230309193326_Added_NumberingConfigDetail")]
    partial class AddedNumberingConfigDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DMSpro.OMS.MdmService.ItemGroupInZones.ItemGroupInZone", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SellingZoneId");

                    b.ToTable("ItemGroupInZones", (string)null);
                });
            ...
            modelBuilder.Entity("DMSpro.OMS.MdmService.ItemGroupInZones.ItemGroupInZone", b =>
                {
                    ...
                    b.HasOne("DMSpro.OMS.MdmService.SalesOrgHierarchies.SalesOrgHierarchy", "SellingZone")
                        .WithMany()
                        .HasForeignKey("SellingZoneId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("ItemGroup");

                    b.Navigation("SellingZone");
                });
            ...
            modelBuilder.Entity("DMSpro.OMS.MdmService.NumberingConfigDetails.NumberingConfigDetail", b =>
                {
                    ...
                    b.HasOne("DMSpro.OMS.MdmService.NumberingConfigs.NumberingConfig", null)
                        .WithMany()
