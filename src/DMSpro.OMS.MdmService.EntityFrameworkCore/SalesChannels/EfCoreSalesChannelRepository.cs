...
namespace DMSpro.OMS.MdmService.SalesChannels
{
    public class EfCoreSalesChannelRepository : EfCoreRepository<MdmServiceDbContext, SalesChannel, Guid>, ISalesChannelRepository
    {
        ...
        public async Task<List<SalesChannel>> GetListAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? SalesChannelConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<SalesChannel> ApplyFilter(
            IQueryable<SalesChannel> query,
            string filterText,
            string code = null,
            string name = null,
            string description = null,
