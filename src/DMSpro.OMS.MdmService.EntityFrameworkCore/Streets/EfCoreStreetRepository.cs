...
namespace DMSpro.OMS.MdmService.Streets
{
    public partial class EfCoreStreetRepository : EfCoreRepository<MdmServiceDbContext, Street, Guid>, IStreetRepository
    {
        ...
        public async Task<List<Street>> GetListAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? StreetConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<Street> ApplyFilter(
