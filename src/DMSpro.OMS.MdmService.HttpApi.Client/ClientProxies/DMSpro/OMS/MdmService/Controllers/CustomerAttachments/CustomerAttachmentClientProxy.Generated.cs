...
public partial class CustomerAttachmentClientProxy : ClientProxyBase<ICustomerAttachmentsAppService>, ICustomerAttachmentsAppService
{
    ...
    public virtual async Task<CustomerAttachmentDto> CreateAsync(Guid customerId, IRemoteStreamContent inputFile, string description, bool active)
    {
    ...
    public virtual async Task<CustomerAttachmentDto> UpdateAsync(Guid id, Guid customerId, IRemoteStreamContent inputFile, string description, bool active)
    {
