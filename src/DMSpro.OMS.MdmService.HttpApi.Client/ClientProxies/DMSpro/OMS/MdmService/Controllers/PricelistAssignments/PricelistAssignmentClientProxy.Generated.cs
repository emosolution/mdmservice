...
[ExposeServices(typeof(IPartialAppService), typeof(PricelistAssignmentClientProxy))]
public partial class PricelistAssignmentClientProxy : ClientProxyBase<IPartialAppService>, IPartialAppService
{
    ...
    {
        return await RequestAsync<PagedResultDto<PricelistAssignmentWithNavigationPropertiesDto>>(nameof(GetListAsync), new ClientProxyRequestTypeValue
        {
            { typeof(GetPricelistAssignmentsInput), input }
        });
    }

    public virtual async Task<PricelistAssignmentWithNavigationPropertiesDto> GetWithNavigationPropertiesAsync(Guid id)
    {
        return await RequestAsync<PricelistAssignmentWithNavigationPropertiesDto>(nameof(GetWithNavigationPropertiesAsync), new ClientProxyRequestTypeValue
        {
            { typeof(Guid), id }
        });
    }
    ...
    public virtual async Task<IRemoteStreamContent> GetListAsExcelFileAsync(PricelistAssignmentExcelDownloadDto input)
    {
        ...
        {
            { typeof(PricelistAssignmentExcelDownloadDto), input }
        });
    }
