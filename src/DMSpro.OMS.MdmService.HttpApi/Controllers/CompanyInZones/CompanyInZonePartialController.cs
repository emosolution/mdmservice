...
namespace DMSpro.OMS.MdmService.Controllers.CompanyInZones
{
	public partial class CompanyInZoneController
	{
		...
		{
			return _companyInZonesAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _companyInZonesAppService.InsertFromExcelAsync(file);
		}
        ...
        {
            return _companyInZonesAppService.GenerateExcelTemplatesAsync();
		}
	}
}