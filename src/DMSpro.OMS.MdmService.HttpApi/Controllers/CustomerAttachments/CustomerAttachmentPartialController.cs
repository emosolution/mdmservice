...
namespace DMSpro.OMS.MdmService.Controllers.CustomerAttachments
{
	public partial class CustomerAttachmentController
	{
		...
		{
			return _customerAttachmentsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _customerAttachmentsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _customerAttachmentsAppService.GenerateExcelTemplatesAsync();
        }
	}
}