...
namespace DMSpro.OMS.MdmService.Controllers.CustomerGroups
{
	public partial class CustomerGroupController
	{
		...
		{
			return _customerGroupsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _customerGroupsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _customerGroupsAppService.GenerateExcelTemplatesAsync();
        }
	}
}