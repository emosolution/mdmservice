...
namespace DMSpro.OMS.MdmService.Controllers.Customers
{
	public partial class CustomerController
	{
		...
		{
			return _customersAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _customersAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _customersAppService.GenerateExcelTemplatesAsync();
        }
	}
}