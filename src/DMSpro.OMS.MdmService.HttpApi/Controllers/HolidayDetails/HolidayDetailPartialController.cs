...
namespace DMSpro.OMS.MdmService.Controllers.HolidayDetails
{
	public partial class HolidayDetailController
	{
		...
		{
			return _holidayDetailsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _holidayDetailsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _holidayDetailsAppService.GenerateExcelTemplatesAsync();
        }
	}
}