...
namespace DMSpro.OMS.MdmService.Controllers.MCPDetails
{
	public partial class MCPDetailController
	{
		...
		{
			return _mCPDetailsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _mCPDetailsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _mCPDetailsAppService.GenerateExcelTemplatesAsync();
        }
	}
}