...
namespace DMSpro.OMS.MdmService.Controllers.PriceLists
{
    public partial class PriceListController
    {
        ...
        {
            return _priceListsAppService.UpdateFromExcelAsync(file);
        }
        ...
        {
            return _priceListsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _priceListsAppService.GenerateExcelTemplatesAsync();
        }
    }
}