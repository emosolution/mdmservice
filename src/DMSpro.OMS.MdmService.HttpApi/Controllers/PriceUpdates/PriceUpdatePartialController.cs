...
namespace DMSpro.OMS.MdmService.Controllers.PriceUpdates
{
	public partial class PriceUpdateController
	{
		...
		{
			return _priceUpdatesAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _priceUpdatesAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _priceUpdatesAppService.GenerateExcelTemplatesAsync();
        }
	}
}