...
namespace DMSpro.OMS.MdmService.Controllers.UOMGroups
{
	public partial class UOMGroupController
	{
		...
		{
			return _uOMGroupsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _uOMGroupsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _uOMGroupsAppService.GenerateExcelTemplatesAsync();
        }
	}
}