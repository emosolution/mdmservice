...
namespace DMSpro.OMS.MdmService.Controllers.Vendors
{
	public partial class VendorController
	{
		...
		{
			return _vendorsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _vendorsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _vendorsAppService.GenerateExcelTemplatesAsync();
        }
	}
}