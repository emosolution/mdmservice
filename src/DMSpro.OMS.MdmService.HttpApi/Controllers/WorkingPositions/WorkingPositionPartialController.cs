...
namespace DMSpro.OMS.MdmService.Controllers.WorkingPositions
{
	public partial class WorkingPositionController
	{
		...
		{
			return _workingPositionsAppService.UpdateFromExcelAsync(file);
		}
        ...
        {
            return _workingPositionsAppService.InsertFromExcelAsync(file);
        }
        ...
        {
            return _workingPositionsAppService.GenerateExcelTemplatesAsync();
        }
	}
}