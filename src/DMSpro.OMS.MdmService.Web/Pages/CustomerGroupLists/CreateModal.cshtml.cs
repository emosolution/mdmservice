...
namespace DMSpro.OMS.MdmService.Web.Pages.CustomerGroupLists
{
    ...
    {
        [BindProperty]
        public CustomerGroupListCreateViewModel CustomerGroupList { get; set; }
        ...
        public CreateModalModel(ICustomerGroupListsAppService customerGroupListsAppService)
        {
        ...
        {
            CustomerGroupList = new CustomerGroupListCreateViewModel();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _customerGroupListsAppService.CreateAsync(ObjectMapper.Map<CustomerGroupListCreateViewModel, CustomerGroupListCreateDto>(CustomerGroupList));
            return NoContent();
        }
    }

    public class CustomerGroupListCreateViewModel : CustomerGroupListCreateDto
    {
    }
}