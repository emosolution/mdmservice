...
namespace DMSpro.OMS.MdmService.Companies
{
    public class CompaniesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("d45111bf-4879-49ce-9cc6-313f51f8b197"),
                ...
                active: true,
                effectiveDate: new DateTime(2017, 9, 26),
            ...
            await _companyRepository.InsertAsync(new Company
            (
                id: Guid.Parse("9d7230d0-7215-4dfb-b0e9-b9d2d726b278"),
                ...
                active: true,
                effectiveDate: new DateTime(2007, 8, 12),
                endDate: new DateTime(2009, 10, 10),
                isHO: true,
