...
namespace DMSpro.OMS.MdmService.Customers
{
    public class CustomersDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("ce6d421c-4cde-493f-b12f-e6fa307128be"),
                ...
                active: true,
                effectiveDate: new DateTime(2018, 1, 22),
                endDate: new DateTime(2007, 4, 8),
                creditLimit: 1571919124,
                isCompany: true,
                ...
                lastOrderDate: new DateTime(2011, 8, 5),
                paymentTermId: null,
            ...
            await _customerRepository.InsertAsync(new Customer
            (
                id: Guid.Parse("8565be3d-2c64-4899-97f6-f45fa01bdfb7"),
                ...
                active: true,
                effectiveDate: new DateTime(2006, 1, 3),
                endDate: new DateTime(2018, 7, 1),
                creditLimit: 743968051,
                isCompany: true,
                ...
                lastOrderDate: new DateTime(2002, 2, 24),
                paymentTermId: null,
                linkedCompanyId: null,
                priceListId: Guid.Parse("8c8c5f33-b4f5-48e0-895d-60f857e7b1f5"),
                geoMaster0Id: null,
