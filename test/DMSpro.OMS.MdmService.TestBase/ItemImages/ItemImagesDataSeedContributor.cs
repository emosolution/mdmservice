...
namespace DMSpro.OMS.MdmService.ItemImages
{
    public class ItemImagesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        ...
        public ItemImagesDataSeedContributor(IItemImageRepository itemImageRepository, IUnitOfWorkManager unitOfWorkManager, ItemsDataSeedContributor itemsDataSeedContributor)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("ac84691f-4f55-405b-b946-9f9eea7e761f"),
                ...
                active: true,
                displayOrder: 1415616311,
                itemId: Guid.Parse("d318ea89-992c-4d36-bef0-2b12495d19e5")
            ));

            await _itemImageRepository.InsertAsync(new ItemImage
            (
                id: Guid.Parse("4c1561df-fcc3-4df7-ba24-5c5bb0c6e391"),
